class command():
    ...
    cmd_report_form="SELECT project,b.structure,b.num_of_mysql,b.num_of_server,a.max_row_table,SUM(a.total_rows) AS total_rows,CAST(AVG(a.avg_qps) AS UNSIGNED) AS avg_qps,cast(a.uptime as char(3)) as uptime_days,CAST(AVG(a.connections) AS UNSIGNED) AS connections \
